...
const (
	...
	ExecutePrecompileGas uint64 = 0    // Placeholder gas price for the EXECUTE precompile (Native Rollup)
...
var (
	...
	// This precompile verifies Native Rollup state transitions per EIP-8079.
	ExecutePrecompileAddress = common.BytesToAddress([]byte{0x12})

	// AnchorAddress is the predeploy address for L1->L2 message anchoring per EIP-8079.
	// The EXECUTE precompile injects anchor data here via a system transaction.
	AnchorAddress = common.HexToAddress("0x0000000000000000000000000000000000008079")
)
